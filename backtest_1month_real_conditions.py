"""
Backtest 1 mes (1-May-2026 → 1-Jun-2026) con reglas de salida reales:
...
SPREAD_PCT = 0.0002        # 0.02% spread (solo en entrada)
...
# ---------- SIMULACIÓN DE SALIDAS CON REGLAS REALES ----------
...
def main():
    ...
    if all_trades:
        ...
        csv_name = 'backtest_1month_real_conditions.csv'
        ...
        print("\n========== RESUMEN 1 MES (CONDICIONES REALES) ==========")
