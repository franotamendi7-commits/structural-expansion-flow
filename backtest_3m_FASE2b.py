"""
BACKTEST 3 MESES (últimos 90 días) - FASE 2b
Ajustes: Supertrend más sensible (multiplier reducido), Choppiness como en Fase 1.
"""
...
# ──────────── MOTOR ORIGINAL (Fase 2b: Supertrend más sensible) ────────────
SYMBOL_CONFIG = {
        ...
        try:
            ...
            if signal in ('LONG', 'SHORT'):
                ...
                if enhanced['veto']:
                    ...
                    signal = 'WAIT'; setup_state = 'INVALID'
            # Fase 2b: el veto extra Supertrend LONG sigue eliminado
...
if all_trades:
    ...
    csv_name = 'backtest_3m_FASE2b.csv'
