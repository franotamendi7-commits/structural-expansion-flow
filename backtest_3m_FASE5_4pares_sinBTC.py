"""
BACKTEST 3 MESES (últimos 90 días) – FASE 5 con 4 pares (ETH, SOL, XRP, BNB)
...
# ────────────────────── CONFIGURACIÓN ──────────────────────
SYMBOLS = ["ETHUSDT", "SOLUSDT", "XRPUSDT", "BNBUSDT"]
...
if all_trades:
    ...
    csv_name = 'backtest_3m_FASE5_4pares_sinBTC.csv'
    ...
    print("\n========== RESULTADOS 3 MESES (FASE 5 – 4 PARES SIN BTC) ==========")
