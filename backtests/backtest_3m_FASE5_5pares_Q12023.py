"""
BACKTEST Q1 2023 (1 enero – 31 marzo 2023) – FASE 5 con 5 pares (BTC, ETH, SOL, XRP, BNB)
...
END_DATE   = datetime(2023, 3, 31, 23, 59, tzinfo=timezone.utc)
MAX_KLINES = 1000
...
if all_trades:
    ...
    csv_name = 'backtest_3m_FASE5_5pares_Q12023.csv'
    ...
    print("\n========== RESULTADOS Q1 2023 (FASE 5 – 5 PARES) ==========")
