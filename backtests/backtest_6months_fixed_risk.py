"""
Backtesting multi‑par (6 meses) - RIESGO FIJO 1% constante.
Período: 27‑Nov‑2025 → 27‑May‑2026
"""
import sys, os, time
sys.path.insert(0, '.')
import numpy as np
...
START_DATE = datetime(2025, 11, 27, tzinfo=timezone.utc)
...
def main():
    ...
    if all_trades:
        ...
        csv_name = 'backtest_6months_fixed_risk.csv'
