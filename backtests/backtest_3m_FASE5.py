"""
BACKTEST 3 MESES (últimos 90 días) - FASE 5 (Ultra Equilibrio)
Fase 4 base + CI thresholds elevados + eliminar confirmación 15m.
Señal solo por engulfing 4h + filtros finos. Fibonacci obligatorio.
"""
...
class ScalpingEngine:
    ...
    def run(self, klines, current_price):
        try:
            ...
            # Señal solo por engulfing 4h (sin confirmación 15m)
...
if all_trades:
    ...
    csv_name = 'backtest_3m_FASE5.csv'
