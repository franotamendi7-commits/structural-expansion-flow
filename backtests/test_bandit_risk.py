...
def run_backtest(risk_levels, alpha=1.0):
...
bandit_A.save("bandit_risk_A.json")
bandit_B.save("bandit_risk_B.json")
print("\nModelos guardados: bandit_risk_A.json, bandit_risk_B.json")
