#!/usr/bin/env python3
"""
Optimización Bayesiana (Optuna) para BTCUSDT – Walk‑Forward trimestral (ligero).
...
Versión con datos reducidos (desde 2024-06-01) y folds desde 2024-07-01.
"""
...
# ═══════════════════ CONFIGURACIÓN ═══════════════════
SYMBOL = "BTCUSDT"
DATA_START = datetime(2024, 6, 1, tzinfo=timezone.utc)          # ← acortado
...
# ═══════════════════ WALK‑FORWARD FOLDS (desde 2024‑07‑01) ═══════════════════
def generar_folds():
    folds = []
    start = datetime(2024, 7, 1, tzinfo=timezone.utc)
    end = datetime(2024, 9, 30, 23, 59, tzinfo=timezone.utc)
...
if __name__ == "__main__":
    ...
    study.optimize(objective, n_trials=30, show_progress_bar=True)  # ← 30 trials
