"""
BACKTEST Q3 2024 (1 julio – 30 septiembre 2024) – FASE 5 con 5 pares (BTC, ETH, SOL, XRP, BNB)
...
START_DATE = datetime(2024, 7, 1, 0, 0, tzinfo=timezone.utc)
END_DATE   = datetime(2024, 9, 30, 23, 59, tzinfo=timezone.utc)
MAX_KLINES = 1000
...
if all_trades:
    ...
    csv_name = 'backtest_3m_FASE5_5pares_Q32024.csv'
    ...
    print("\n========== RESULTADOS Q3 2024 (FASE 5 – 5 PARES) ==========")
