"""
Backtesting multi‑par (6 meses RELAJADO): 27‑Nov‑2025 al 27‑May‑2026.
...
START_DATE = datetime(2025, 11, 27, tzinfo=timezone.utc)   # ← 6 meses atrás
END_DATE   = datetime(2026, 5, 27, tzinfo=timezone.utc)
MAX_KLINES = 1000
BASE_URL   = "https://api.binance.com/api/v3/klines"
INITIAL_CAPITAL = 100.0
BASE_RISK_PCT = 0.01                # Podés ajustar a 0.0075 si querés
MAX_DAILY_LOSS_PCT = 0.05           # 5 %
MAX_CONSECUTIVE_LOSSES = 7          # kill switch en 7
...
def main():
    ...
    if all_trades:
        ...
        csv_name = 'backtest_6months_relaxed.csv'
