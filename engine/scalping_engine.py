...
class ScalpingEngine:
    ...
    def _calculate_dynamic_score(self, direction, fib_block, enhanced, mom, klines_4h, klines_15m):
        """
        Score dinámico 0‑100 recalibrado para generar 60‑80 trades en 3 meses.
        - Base 70
        - Engulfing suma si cuerpo > 40% del rango
        - Choppiness < 60 suma puntos
        - Penalización contrarian eliminada (0)
        - Momentum x20 (máx 20 puntos)
        """
        score = 70  # base incrementada

        # 1. Claridad del engulfing 4H (cuerpo > 40% del rango)
        ...
        # 6. Penalización contrarian eliminada (0)
    ...
    def run(self):
        try:
            ...
            # --- NUEVA VERIFICACIÓN: datos de red ---
            if klines is None:
            ...
            # --- NUEVO try/except para procesamiento de volúmenes ---
            try:
