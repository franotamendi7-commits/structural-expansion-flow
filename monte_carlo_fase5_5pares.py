...
CSV = 'backtest_3m_FASE5_5pares.csv'
N_SIM = 10_000
...
print("\n========== MONTE CARLO FASE 5 (5 pares, 133 trades, 10,000 simulaciones) ==========")
...
resultados.to_csv('monte_carlo_fase5_5pares.csv', index=False)
print("\n📁 Resultados detallados guardados en monte_carlo_fase5_5pares.csv")
...
try:
    ...
    plt.title('Distribución del PnL Final – Monte Carlo Fase 5 (5 pares)')
    plt.xlabel('PnL Final ($)')
    plt.ylabel('Frecuencia')
    plt.legend()
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig('monte_carlo_fase5_5pares_hist.png', dpi=150)
    print("📊 Histograma guardado como monte_carlo_fase5_5pares_hist.png")
except ImportError:
